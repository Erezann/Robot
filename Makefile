...
EXEC=robot
OBJ_FILES = testRobot.o  Robot.o  Etat/Fige.o  Etat/EnRoute.o  Etat/AVide.o Etat/AVideFacePlot.o Etat/EnCharge.o Etat/EnChargeFacePlot.o  Etat/Etat.o View/Afficheur.o View/ElementARepresenter.o View/AfficheurTexte.o Commande/Commande.o Commande/LireEntree.o 
